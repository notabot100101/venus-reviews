# Affiliate Application Pack — ready-to-paste answers

Prepared 2026-08-07 after the ratings cleanup (`bf10dbc`). Program list and
signup URLs: `AFFILIATE-PROGRAMS.md`. Every answer below is true as of today —
do not embellish any of them on a form; the honest versions are the approvable
versions.

## Standard fields (all programs)
...
| Contact e-mail | Paul chooses — must be one he actually reads |

## Per-program notes

- **LELO** (lip.hasoffers.com) — 5 LELO products reviewed, strongest catalogue fit. Mention Gigi 2, Sona 2, Mona 2, Enigma, Sila by name.
- **Womanizer / We-Vibe** (impact.com, one WOW Tech group) — 3 products reviewed across both brands; Premium 2 review notes manufacturer stock-out honestly.
- **SheVibe** (impact.com) — retailer, carries most of the catalogue.
- **Adam & Eve** (pepperjam) — US retailer breadth.
- **b-Boutique** (Awin) — EU coverage.
- **Amazon Associates** — their unsuitable-sites policy covers sexually explicit material; an adult-category site is a likely rejection. Apply last or skip; a rejection there has no bearing on the others.
- **Lovehoney** — declined 2026-07-29. The site has changed substantially since
  (ratings removed, prices verified, invented products gone, imagery added).
  Reasonable to re-apply after a couple of weeks of the new state being live,
  referencing the relaunch.

## What agents must NOT do on these forms

Account creation, passwords, payment details, and tax IDs are Paul's steps,
always. Agents prepare and verify; Paul submits anything behind a login or
...
- [ ] No page claims physical testing
